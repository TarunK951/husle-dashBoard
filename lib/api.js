/**
 * Dashboard API client. All requests go to /api/* and are proxied to NEXT_PUBLIC_API_URL
 * (see next.config.mjs). Aligned with Hustle Life Backend API reference:
 * - Auth: /auth/register, /auth/login
 * - Products: /products (GET list, GET /:id, POST, PUT /:id, DELETE /:id)
 * - Categories: /categories | Admin content (Section 11): /admin/homepage/*, /admin/blog,
 *   /admin/page/about, /admin/support, /admin/navigation, /admin/search-config
 */
const BASE_URL = "/api";
